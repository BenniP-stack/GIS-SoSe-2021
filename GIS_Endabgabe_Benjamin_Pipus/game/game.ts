namespace Endabgabe {
    ...
    class Game {
        ...
        constructor(_fieldHtml: HTMLElement, _scoreFormHtml: HTMLElement, _timerHtml: HTMLElement) {
            ...
            let formElem: HTMLFormElement = _scoreFormHtml.querySelector("form");
        ...
        shuffle(_array: any): [] { //Fisher-Yates (aka. Knuth) Shuffle Algorithmus (https://scotch.io/tutorials/how-to-build-a-memory-matching-game-in-javascript#toc-1-shuffing-cards)
            let currentIndex: number = _array.length, temporaryValue: number, randomIndex: number;
        ...
        clickHandler(_index: number): void {
    ...
    function handleClick(_index: number): void {
