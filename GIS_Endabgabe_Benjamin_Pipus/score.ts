function sortByProperty(property: any) {  //https://medium.com/@asadise/sorting-a-json-array-according-one-property-in-javascript-18b1d22cd9e9
    return function (a: any, b: any) {
        if ((a[property] as number) > (b[property] as number))
            return 1;
        else if ((a[property] as number) < (b[property] as number))
            return -1;
